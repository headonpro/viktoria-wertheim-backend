...
export abstract class FeatureFlagEnabledHookService extends BaseHookService {
  ...
  protected async isFeatureEnabled(flagName: string, context?: Partial<FeatureFlagContext>): Promise<boolean> {
    ...
    try {
      ...
      this.logError(error as Error, { contentType: "feature-flag", hookType: "afterUpdate", event: { params: {} }, operationId: "check-feature-flag" });
      return false;
    }
  }
  ...
  protected async getFeatureValue(flagName: string, context?: Partial<FeatureFlagContext>): Promise<any> {
    ...
    try {
      ...
      this.logError(error as Error, { contentType: "feature-flag", hookType: "afterUpdate", event: { params: {} }, operationId: "get-feature-flag-value" });
      return null;
    }
  }

 ...
 */
export const validatePostgreSQLConfig = (env: any): DatabaseValidationResult => {
 ...
 */
export const validateSQLiteConfig = (env: any): DatabaseValidationResult => {
  const result: DatabaseValidationResult = {
    isValid: true,
    errors: [],
    warnings: []
 ...
 */
export const validateDatabaseConfig = (env: any): DatabaseValidationResult => {
 ...
 */
export const logValidationResults = (result: DatabaseValidationResult, client: string): void => {

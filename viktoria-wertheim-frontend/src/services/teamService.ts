...
export const teamService = {
   ...
   */
  calculateTeamStats(games: GameDetails[], teamName: string): TeamStats {
   ...
   */
  generateFormArray(games: GameDetails[], teamName: string, count: number = 5): ('S' | 'U' | 'N')[] {
